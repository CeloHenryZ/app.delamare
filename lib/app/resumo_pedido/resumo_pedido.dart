...
import 'package:loja_delamare/app/pdf/pdf_view.dart';
import 'package:loja_delamare/app/providers/itens_pedido_list.dart';
import 'package:loja_delamare/app/widgets/cardResumo.dart';
import 'package:loja_delamare/app/widgets/colors.dart';
import 'package:loja_delamare/database/database.dart';
                      ...
                      pdfLib.Container(
                          ...
                          child: pdfLib.Column(
                              ...
                              children: [
                                ...
                                pdfLib.Text(
                                  'Número do WhatsApp: (38)98847-0267',
                                  style: pdfLib.TextStyle(
                                        ...
                                        child: Container(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            onTap: () async {
                                              ...
                                              try {
                                                await launch(
                                                    'https://api.whatsapp.com/send?phone=5569993329909');
                                              } catch (error) {
                                                print(error);
                                              }
                                            },
